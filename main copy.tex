...
Rule 4 menggunakan kondisi suhu dingin dan kelembapan lembap sehingga menghasilkan kategori kuning. Rule 5 menggunakan kondisi suhu sedang dan kelembapan lembap sehingga menghasilkan kategori hijau. Kedua rule tersebut dapat dihitung karena seluruh derajat keanggotaan yang terlibat bernilai lebih besar dari nol.

Rule yang aktif, yaitu rule dengan $\alpha > 0$, adalah Rule 4 dan Rule 5. Karena masing-masing rule menghasilkan kategori keluaran yang berbeda, yaitu Rule 4 menghasilkan kategori kuning dan Rule 5 menghasilkan kategori hijau, tidak diperlukan proses agregasi dengan nilai maksimum sebagaimana dilakukan apabila terdapat beberapa rule dengan kategori keluaran yang sama. Nilai $\alpha$ masing-masing rule langsung menjadi kekuatan akhir kategori keluarannya.

\[
\alpha_{\text{kuning}} = \alpha_4 = 0{,}25
\]
...
Melanjutkan contoh sebelumnya, Rule 5 menghasilkan keluaran hijau dengan kekuatan $0{,}4$, sedangkan Rule 4 menghasilkan keluaran kuning dengan kekuatan $0{,}25$. Maka nilai keluaran akhir dihitung sebagai berikut.
