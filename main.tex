...
Metode yang digunakan adalah rata-rata berbobot (\textit{weighted average}), yang menghitung nilai rata-rata dari seluruh rule yang aktif dengan bobot berupa kekuatan masing-masing rule ($\alpha$). Nilai yang dibobotkan berupa nilai representatif dari kategori keluaran rule tersebut, yaitu 0 untuk merah, 50 untuk kuning, dan 100 untuk hijau. Persamaan yang digunakan adalah sebagai berikut.
