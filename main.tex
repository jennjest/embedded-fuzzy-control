...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{p{0.25\textwidth} p{0.15\textwidth} X}
        ...
        Suhu &
        Sedang &
        Suhu relatif sesuai dengan kondisi pengamatan \\
        ...
        Kelembapan tanah &
        Kering &
        Media relatif kering \\

        Kelembapan tanah &
        Lembap &
        Media memiliki kelembapan yang sesuai \\
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{c L L L}
        ...
        R2 & Rendah & Lembap & Kuning \\
        R3 & Rendah & Basah & Kuning \\
        R4 & Sedang & Kering & Kuning \\
        R5 & Sedang & Lembap & Hijau \\
        R6 & Sedang & Basah & Hijau \\
        R7 & Tinggi & Kering & Merah \\
        R8 & Tinggi & Lembap & Kuning \\
        R9 & Tinggi & Basah & Kuning \\

        \bottomrule
    \end{tabularx}
\end{table}

Aturan R5 dapat dibaca sebagai: jika suhu berada pada kategori sedang dan kelembapan tanah berada pada kategori lembap, maka kondisi tanaman dinyatakan relatif baik. Aturan R7 menunjukkan bahwa kombinasi suhu tinggi dan media kering perlu diberi perhatian lebih besar sehingga indikator diarahkan ke merah. Aturan lain digunakan untuk menjaga agar kondisi antara tidak langsung dipetakan sebagai kondisi terbaik atau terburuk.
...
\begin{enumerate}
    ...
    \item Atur hair dryer pada mode udara dingin.
    \item Arahkan aliran udara ke area sensor dengan jarak yang aman.
    \item Amati perubahan nilai suhu yang terbaca pada Serial Monitor.
    \item Catat nilai suhu pada kondisi udara dingin.
    \item Atur hair dryer pada mode udara panas.
    \item Arahkan aliran udara ke area sensor dengan jarak yang aman.
...
Analisis dilakukan dengan membandingkan pembacaan sensor pada kondisi rockwool yang berbeda dan pada beberapa kondisi suhu. Perhatikan perubahan nilai kelembapan tanah ketika rockwool berada pada kondisi kering, lembap, dan basah. Selain itu, amati perbedaan suhu yang terbaca pada kondisi suhu ruangan, ketika sensor terkena udara dingin, dan ketika sensor terkena udara panas dari hair dryer.
...
\begin{itemize}
    ...
    \item[$\checkbox$] Nilai suhu berubah ketika sensor terkena udara dingin dari hair dryer.
    \item[$\checkbox$] Nilai suhu berubah ketika sensor terkena udara panas dari hair dryer.
...
Analisis pada percobaan kedua berfokus pada hubungan antara perubahan input dan keluaran sistem. Perhatikan perubahan LED pada berbagai kondisi rockwool serta perubahan keluaran ketika suhu berubah akibat penggunaan hair dryer. Hasil pengamatan dibandingkan dengan kecenderungan yang dihasilkan oleh membership function dan rule yang telah dibuat.
